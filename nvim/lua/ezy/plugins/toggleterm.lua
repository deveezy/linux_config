...
vim.api.nvim_set_keymap("n", "<m-4>", "<cmd>lua _BTOP_TOGGLE()<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("i", "<m-4>", "<cmd>lua _BTOP_TOGGLE()<CR>", { noremap = true, silent = true })
